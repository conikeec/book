...
One of stable, beta, or nightly version of Rust is OK. You can put Rust installation in `PATH` or set `CARGO_HOME` environment varible to the path of `cargo.exe`. 
