...
Get [R > 3.3.0](https://cran.r-project.org/bin/windows/base/R-3.3.0beta-win.exe) build with GCC 4.9 and [Rtools 3.3](https://cran.r-project.org/bin/windows/Rtools/Rtools33.exe)
