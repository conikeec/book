...
Get [R > 3.4.0](https://cran.r-project.org/bin/windows/base/R-devel-win.exe) build with GCC 4.9 and [Rtools 3.3](https://cran.r-project.org/bin/windows/Rtools/Rtools33.exe)
